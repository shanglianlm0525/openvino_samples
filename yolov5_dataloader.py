# !/usr/bin/env python
# -- coding: utf-8 --
# @Time : 2023/5/25 15:34
# @Author : liumin
# @File : yolov5_dataloader.py
...
from openvino.yolov5_augmentations import Albumentations, mixup, random_perspective, augment_hsv, copy_paste
from openvino.yolov5_general import xyn2xy, xywhn2xyxy, xyxy2xywhn
from openvino.yolov5_utils import letterbox
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        if isinstance(img_size, int):
            ...
            self.mosaic_border = [-img_size[0] // 2, -img_size[1] // 2]  # h,w
        self.stride = stride
        self.path = path
    ...
    def check_cache_ram(self, safety_margin=0.1, prefix=''):
        ...
        for _ in range(n):
            ...
            if isinstance(self.img_size, int):
                ...
                ratio = max(self.img_size) / max(im.shape[0], im.shape[1])  # max(h, w)  # ratio
            b += im.nbytes * ratio ** 2
    ...
    def cache_labels(self, path=Path('./labels.cache'), prefix=''):
        ...
        if msgs:
            print('\n'.join(msgs))
        if nf == 0:
            print(f'{prefix}WARNING ⚠️ No labels found in {path}. {HELP_URL}')
    ...
    def load_mosaic(self, index):
        ...
        img4, labels4 = random_perspective(img4,
                                           ...
                                           ar_thr=self.ar_thr)  # border to remove
