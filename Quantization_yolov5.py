# !/usr/bin/env python
# -- coding: utf-8 --
# @Time : 2023/5/25 14:19
# @Author : liumin
# @File : Quantization_yolov5.py
...
from openvino.yolov5_general import check_yaml, check_dataset
from openvino.yolov5_utils import ap_per_class, non_max_suppression, scale_coords, xywh2xyxy, process_batch
...
print("FP32 model metric_results: {}".format(metric_results_fp32))
...
print("Save quantized model in {}".format(optimized_save_dir))
